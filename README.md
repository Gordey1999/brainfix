...
![Интерфейс BrainFix Studio](docs/docs/assets/img/brainfix-preview.png)
...
[Документация](https://gordey1999.github.io/brainfix/docs/)
...
![Интерфейс BrainFix Studio](docs/docs/assets/img/studio-preview.png)
...
[BrainFix Studio](https://gordey1999.github.io/brainfix/)
...
* **Игра «Сапер»** — классическая головоломка с генерацией поля и открытием ячеек.
  ![Сапер](docs/docs/assets/img/saper.gif)
* **Игра «Ним»** — математическая игра против искусственного интеллекта.
  ![Ним](docs/docs/assets/img/nim.gif)

Эти и другие программы можно запустить в BrainFix Studio.  
